...
//private:
	...
	typedef struct DirSpotLight
	{
		alignas(16) glm::vec3 ambientSpot;
		float innerCutoffSpot;
		alignas(16) glm::vec3 diffuseSpot;
		float outerCutoffSpot;
		alignas(16) glm::vec3 specularSpot;
		float constantSpot; 
		alignas(16) glm::vec3 ambientDir;
		float linearSpot;
		alignas(16) glm::vec3 diffuseDir;
		float quadraticSpot;
		alignas(16) glm::vec4 directionDir;
		alignas(16) glm::vec3 specularDir;
	}DirSpotLight;
	...
	glm::vec4 pointLightPositions[POINT_LIGHTS_NUMBER] =
	{
